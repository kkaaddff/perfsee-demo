...
function QualityTools() {
    ...
    if (tabIndex === TITLE_SWITCH_VALUE.specailLine) {
        return React.createElement(SpecialLineWebview, null);
    }
    if (pageLoading) {
        return React.createElement(InitPage, null);
    }
    return (React.createElement(ScrollView, { className: styles.pageCont, scrollWithAnimation: true,
        // @ts-ignore
